...
import { annotationDefinitions, CommentStatus, type IAnnotationStore, PdfjsAnnotation } from '../const/definitions'
...
const parserMap: {
    ...
    [PdfjsAnnotation.TEXT]: TextParser,
    [PdfjsAnnotation.HIGHLIGHT]: HighlightParser,
    [PdfjsAnnotation.UNDERLINE]: UnderlineParser,
    [PdfjsAnnotation.STRIKEOUT]: StrikeOutParser,
    [PdfjsAnnotation.SQUARE]: SquareParser,
    [PdfjsAnnotation.CIRCLE]: CircleParser,
    [PdfjsAnnotation.INK]: InkParser,
    [PdfjsAnnotation.POLYLINE]: PolylineParser,
    [PdfjsAnnotation.FREETEXT]: FreeTextParser,
    [PdfjsAnnotation.STAMP]: StampParser,
    [PdfjsAnnotation.LINE]: LineParser
    // 你可以在这里扩展其他类型的解析器
}
