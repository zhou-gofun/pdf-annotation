...
export class WebSelection {
    ...
    public create(root: HTMLDivElement) {
        ...
        this.highlighterObj.on('selection:create', data => {
            ...
            const pageSelection = Object.groupBy(allSourcesSpan, (span: { closest: (arg0: string) => { (): any; new(): any; getAttribute: { (arg0: string): any; new(): any } } | null }) => {
